"""kedro-parallel-partitioned-bug file for ensuring the package is executable
as `kedro-parallel-partitioned-bug` and `python -m kedro_parallel_partitioned_bug`
"""
import importlib
